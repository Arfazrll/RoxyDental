...
export default function RegisterPerawatPage() {
  ...
  const slides = ['/perawat1.jpg', '/perawat2.jpg', '/perawat3.jpg']; // ganti dengan gambar perawat
        ...
        <div style={{ maxWidth: '420px', width: '100%' }}>
          ...
          <div className="text-start">
            ...
            <div className="mb-3">
              ...
              <input type="text" className="form-control py-2" placeholder="Masukkan nomor registrasi perawat" value={registrationNumber} onChange={(e) => setRegistrationNumber(e.target.value)} />
      ...
      {showSuccess && (
        <div className="position-fixed top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center" style={{ background: 'rgba(0,0,0,0.4)', zIndex: 999 }}>
          <div className="bg-white p-4 rounded shadow-lg text-center" style={{ minWidth: '300px', maxWidth: '90%', animation: 'fadeIn 0.3s ease-in-out' }}>
            ...
            <p className="mb-4" style={{ color: '#555' }}>Akun perawat {name} berhasil dibuat.</p>
