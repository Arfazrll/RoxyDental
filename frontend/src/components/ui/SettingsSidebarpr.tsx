...
export default function SettingsSidebar({ activeMenu, setActiveMenu, onLogout }: Props) {
  ...
  const menuItems: MenuItem[] = [
    { id: "informasi-akun", label: "Informasi Akun", subtitle: "Data profil & akun", icon: User, path: "/dashboard/perawat/profilpr/akunpr" },
    { id: "ganti-password", label: "Ganti Password", subtitle: "Keamanan akun", icon: Lock, path: "/dashboard/perawat/profilpr/passwordpr" },
    { id: "notifikasi", label: "Notifikasi", subtitle: "Pengaturan pemberitahuan", icon: Bell, path: "/dashboard/perawat/profilpr/notifikasipr" },
    { id: "tentang", label: "Tentang", subtitle: "Info aplikasi", icon: CreditCard, path: "/dashboard/perawat/profilpr/settingpr" },
  ];
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="flex gap-3 justify-center pt-4">
            <Button
              ...
              className="px-8 border border-pink-300 text-pink-700 bg-transparent hover:bg-pink-50"
            >
              Batal
            </Button>
